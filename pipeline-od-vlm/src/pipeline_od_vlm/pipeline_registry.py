...
from pipeline_od_vlm.pipelines.evaluate_metrics.pipeline import (
    create_pipeline as evaluate_metrics_pipeline,
)
...
def register_pipelines() -> dict[str, Pipeline]:
    ...
    eval_pipe = evaluate_metrics_pipeline()

    return {
        "__default__": download_pipe
        + download_model_pipe
        + od_pipe
        + vlm_pipe
        + eval_pipe,
        ...
        + od_pipe
        + vlm_pipe,
        "evaluate_metrics": eval_pipe,
        "full_pipeline": download_pipe
        + download_model_pipe
        + od_pipe
        + vlm_pipe
        + eval_pipe,
